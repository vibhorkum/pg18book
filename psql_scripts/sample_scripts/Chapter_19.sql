/* 
To use the Chapter 19 SQL script, connect to a clean aidb database and run the following commands.
Execute them in the psql terminal after connecting to the aidb database.
For creating clean aidb database, you can use the following commands in your terminal:
   psql -f psql_scripts/master_create_aidb.sql -U postgres
